...
#   Sep/29/21: Hotpep has been removed, added eCAMI tool. 2. cgc out reformatting. 3. Fixed multiple GT2s [Qiwei Ge]
#
# Accepts user input
...
def cli_main():
    ...
    # eCAMI
    parser.add_argument('--dbcan_thread', '-dt', default=5)
    ...
    # run_ori(inputFile=args.inputFile, inputType=args.inputType, cluster=args.cluster, dbCANFile=args.dbCANFile,
